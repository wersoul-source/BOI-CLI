...
$url = "https://github.com/wersoul-source/BOI-CLI/releases/download/v$VERSION/boi_${VERSION}_windows_amd64.tar.gz"
Write-Host "↓ Downloading BOI CLI v$VERSION..."
Invoke-WebRequest -Uri $url -OutFile "$env:TEMP\boi.tar.gz"

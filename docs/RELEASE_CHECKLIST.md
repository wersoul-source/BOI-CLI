...
- [ ] Version bumped in `cmd/boi/main.go` (embedded via `-ldflags`)
- [ ] Version in `internal/cli/root.go` (`Version: "x.y.z"`)
...
- [ ] `docs/CLI_COMMANDS.md` updated (if commands changed)
...
# (manual edit: cmd/boi/main.go, internal/cli/root.go)

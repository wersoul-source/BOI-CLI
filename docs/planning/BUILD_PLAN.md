...
- `docs/operations/INSTALLER_FLOW.md` -- Detailed installer flow design
- `docs/operations/INSTALL_PLAN.md` -- Install strategy from 13-tool study
- `docs/archive/FIRST_RUN.md` -- First run experience design
- `docs/operations/RELEASE_CHECKLIST.md` -- Per-release checklist
- `docs/reference/CLI_COMMANDS.md` -- Full command reference
- `docs/architecture/SYSTEM_FLOW.md` -- System operational flow
- `docs/architecture/CLI_ARCHITECTURE.md` -- Internal architecture

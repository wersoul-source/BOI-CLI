...
> Historical v0.1 package map. For the current package boundaries, see
> [STRUCTURE.md](STRUCTURE.md). Command behavior remains documented here until
> the CLI product contract is finalized.
